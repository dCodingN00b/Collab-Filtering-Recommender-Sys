...
<link rel="stylesheet" href="generate-recommend_style.css?version48">
...
echo"<div class= 'generate-frame' style = 'margin-top: 35px;'>";
	echo"<div class='generate' id='generate' style='margin-left:250px;' >";
		...
		echo"<div class = 'generateform' >";
			echo"<form action='' method='POST' id = 'generaterecommendform'>";
...
Alternatively, you can also pull the Product ID from the product URL in the Amazon Web Store.
			...
			echo"<div style = 'margin-top: 80px; text-align: center;'> <span style = 'text-align: center;font-size: 14px; color: #6e6d6d''>How to get <a href = 'documentation.php?part=howitworks&sub=productid#productid' 
			style = 'text-decoration:underline; color: blue;text-align: center;'>Product ID</a>?</span></div>";
			
/*
			$myfile = fopen("pid.txt", "a");
	...
	*/
			...
			echo"</form>";
			echo'<div class="loader" id = "loader" style = "margin-top: 100px; margin-left: 310px;" hidden></div>';
			...
			if(isset($_POST['generatebutton'])){
					...
					$out = array();
					//exec("C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/$user_id/data product $productid 5", $out, $return);
...
$(document).ready(function() {
		$("#generaterecommendform").submit(function(event) {
...
//			var command = 'C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/' + userid + '/data product ' + product + ' 5';
			...
			if (categoryCount == 1){
				...
				command = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryOne + "/ product " + product + " 5";
				
			}
			else if (categoryCount == 2){
				command = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryOne + "/ product " + product + " 5";
				command2 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryTwo + "/ product " + product + " 5";
			}
			else if (categoryCount == 3){
				command = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryOne + "/ product " + product + " 5";
				command2 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryTwo + "/ product " + product + " 5";
				command3 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryThree + "/ product " + product + " 5";
				...
				command2 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryTwo + "/ product " + product + " 5";
				command3 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryThree + "/ product " + product + " 5";
				command4 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryFour + "/ product " + product + " 5";
				...
				command3 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryThree + "/ product " + product + " 5";
				command4 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryFour + "/ product " + product + " 5";
				command5 = "C:/Users/Administrator/AppData/Local/Programs/Python/Python311/python C:/xampp/htdocs/dashboard/FYP/neuralcrawling/neuralcrawling/svdpp_input_csv.py C:/xampp/htdocs/dashboard/FYP/uploads/" + userid + "/data/" + categoryFive + "/ product " + product + " 5";
			...
			$.ajax({
				...
				success: function(result) {
					...
					else if (output.length == 32)
					{
						...
						//$("#result0").html("<h3>" + (categoryOne == 'videogames'? 'Video Games': capitalizeFirstLetter(categoryOne)) + ": </h3>");					
						$("#error0").html("The data uploaded for this category does not the meet the requirement. <br/> There should be at least 5 different products. Please crawl more products before trying again." );
					}
					...
					if (categoryCount > 1) {
						...
						else if (output2.length == 32)
						{
							...
							//$("#result02").html("<h3>" + (categoryTwo == 'videogames'? 'Video Games': capitalizeFirstLetter(categoryTwo)) + ": </h3>");
							$("#error2").html("The data uploaded for this category does not the meet the requirement. <br/> There should be at least 5 different products. Please crawl more products before trying again." );
						}
					}
					...
					if (categoryCount > 2) {
						...
						else if (output3.length == 32)
						{
							...
							//$("#result03").html("<h3>" + (categoryThree == 'videogames'? 'Video Games': capitalizeFirstLetter(categoryThree)) + ": </h3>");
							$("#error3").html("The data uploaded for this category does not the meet the requirement. <br/> There should be at least 5 different products. Please crawl more products before trying again." );
						}
					}
					...
					if (categoryCount > 3) {
						...
						else if (output4.length == 32)
						{
							...
							//$("#result04").html("<h3>" + (categoryFour == 'videogames'? 'Video Games': capitalizeFirstLetter(categoryFour)) + ": </h3>");
							$("#error4").html("The data uploaded for this category does not the meet the requirement. <br/> There should be at least 5 different products. Please crawl more products before trying again." );
						}
					}
					...
					if (categoryCount > 4) {
						...
						else if (output5.length == 32)
						{
							...
							$("#error5").html("The data uploaded for this category does not the meet the requirement. <br/> There should be at least 5 different products. Please crawl more products before trying again." );
						}
					}
