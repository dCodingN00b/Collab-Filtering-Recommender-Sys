...
<link rel="stylesheet" href="generate-recommend-recs_style.css?version12">
<style>
#menu {
	position: fixed;
	margin-left: 180px;
	...
	echo"<div class= 'generate-frame'>";
		echo"<div class='generate' id='generate' style='margin-left:435px;' >";
			echo"<div class = 'generate-title'>";
				echo"<a href ='generate-recommend-recs.php'> <h1 name = 'recommend' style='font-size:30px'> Recommendations</h1></a>";
				echo"<a href = 'generate-ratings-recs.php'><h1 name = 'ratings' style='font-size:30px'>Ratings Prediction</h1></a>";
			echo"</div></br>";
			echo"<form action='' method='POST'>";
			echo"<p style='transform: translate(160%, 200%);display: inline-block;'>Product:  <input type='text' name = 'product' ></p>";
