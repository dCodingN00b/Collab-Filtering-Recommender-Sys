...
<head>
	<meta charset="utf-8">
	<title>RECS</title>
	<link rel="stylesheet" href="Default_Page_Style.css?version95">
...
<header id='navbar'>
		...
		<nav>
			<ul class="nav-titles">
				<li name = 'recs'><a name = 'recs' href="default.php">RECS</a></li>
				<div class="dropdown">
					<button class="dropbutton" onmouseover = "style='color:mediumseagreen'" onmouseout = "style='color:black'">Product	
					</button>
					<div class="dropdown-content">
					  <a href="default.php?id=features">Features</a>
					  <a href="default.php?id=howitworks">How it works</a>
					</div>
				</div>
				<div class="dropdown2">
					...
					<div class="dropdown-content2">
						<a href="default.php?id=indpricing">Individual</a>
						<a href="default.php?id=orgpricing">Organization</a>
					</div>
				</div>
				<li name = 'faq' ><a href="default.php?id=faq">FAQ</a></li>
				<li name = 'aboutus' ><a href="default.php?id=aboutus">About Us</a></li>
		...
		<div class = 'main' id='main'>
			...
			echo"
				...
				<div class = 'main2'>
					...
					using our</br> recommendation engine.</br></br></br><a href = 'default.php?id=features'>Check our features</a></p>
				</div>
				<div class = 'main3'>
					...
					using our recommendation engine.</br></br></br><a href = 'default.php?id=howitworks'>Check how it works</a></p>
				</div>
	...
	#Product > HowItWorks Page
		...
		if ($option == '' or $option == 'howitworksorg'){
			...
			<div class = 'howitworks-bottom'>
				<a href='default.php?id=howitworks&option=howitworksorg#bottom'><h2 name = 'howitworks-org' 
				style='text-align:center; border-bottom:2px solid lightgreen;'>Organization</h2></a>
				<a href='default.php?id=howitworks&option=howitworksind#bottom'><h2 style = 'color:grey' name = 'howitworks-indiv' 
			...
			<div class = 'howitworks-bottom'>
				...
				<a href='default.php?id=howitworks&option=howitworksind#bottom'><h2 name = 'howitworks-indiv' 
	...
	#faq page
		...
		echo'<div class="faq" id="faq">
			...
			echo'<a href = "default.php?id=faq&option=product"><h3 name = "faq-type" id = "faq-type-1"
			style = "border-bottom: 2px solid lightgreen">Product</h3></a>';
			echo"<a href = 'default.php?id=faq&option=price'><h3 name = 'faq-type' id = 'faq-type-2'
	...
	<div class = 'bottom-page'>
		...
		<div class = 'links'>
			<h3>Links<h3>
			<p><a href = 'default.php?id=features'>Features</a></p></br>
			<p><a href = 'default.php?id=howitworks'>How it works</a></p></br>
			<p><a href = 'default.php?id=orgpricing'>Prices (Organization)</a></p></br>
			<p><a href = 'default.php?id=indpricing'>Prices (Individual)</a></p></br>
			<p><a href = 'default.php?id=aboutus'>About Us</a></p></br>
			<p><a href = 'default.php?id=faq'>FAQ</a></p>
		</div>
		<div class = 'startnow'>
			<h3>Start Now<h3>
			<p><a href = 'Login.php'>Login</a></p></br>
			<p><a href = 'org_register.php?id=howitworks'>Sign Up</a></p></br>
		</div>
	</div>
<script>
