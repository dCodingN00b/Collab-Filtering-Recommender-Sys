...
<html>	
<head>
<title>Account Settings - Edit Name</title>
...
if (isset($_POST['submit']) and  ($_POST['submit'] == 'Confirm')){
		$user = new User ();
		$user->editName($_POST['newname'], $userid);
...
<div class = 'reg'>
		...
		<div class = 'fields'>";
			/*<div class = 'text_field'>
					<span>Current Name: </span></br><input type='text' name='oldname' value = '{$row["name"]}' style = 'background-color:silver' disabled />
			</div>*/
		echo"	<div class = 'text_field'>
					<span>New Name: </span></br><input type='text' name='newname' required  />
			</div>";
		echo"</br></br>
