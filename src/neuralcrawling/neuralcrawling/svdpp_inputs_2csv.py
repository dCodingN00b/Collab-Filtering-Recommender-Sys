...
def start():
    try:
        # check whether there are 5 different arguments
        if len(sys.argv) != 6:
            print("Usage: python svdpp_inputs_2csv.py <src filepath1> <src filepath2> <userID> <prodID> <no of recommendation>")
            sys.exit(1)
        ...
        csv_files = []
        for folder in [arg_filepath1, arg_filepath2]:
