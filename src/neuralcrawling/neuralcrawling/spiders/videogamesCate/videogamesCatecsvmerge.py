...
folder_path = 'C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/videogamesCate'
...
def start():
    try:
        ...
        merged_df.to_csv(os.path.join('C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/', 'videogames.csv'), index=False)
