...
folder_path = 'C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/computersCate'
...
def start():
    try:
        ...
        merged_df.to_csv(os.path.join('C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/', 'computers.csv'), index=False)
