...
folder_path = 'C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/toysCate'
...
def start_toysmerge():
    try:
        ...
        merged_df.to_csv(os.path.join('C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/', 'toys.csv'), index=False)
