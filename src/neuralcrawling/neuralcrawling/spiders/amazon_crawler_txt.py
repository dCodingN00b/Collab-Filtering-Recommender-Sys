...
# scrapy crawl amazon_scraping -o 25Mar/BUFFALO-HDD-mix_reviews.json
# change "-o (xx.json)" based on what user likes
#scrapy crawl amazon_scraping_txt -o 6Apr/2-mix.json
#scrapy crawl amazon_scraping_txt -a txt="links.txt" -o 14Apr/sg_out.csv
...
class AmazonReview(scrapy.Spider):
    ...
    def start_requests(self): 
        ...
        for asin in prodID_ls:
            ...
            yield scrapy.Request(url=amazon_reviews_url, callback=self.parse_review, meta={'asin':asin,'url':amazon_site})#, headers=headers
