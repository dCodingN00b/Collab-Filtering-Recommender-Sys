...
folder_path = 'C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/electronicsCate'
...
def start():
    try:
        ...
        merged_df.to_csv(os.path.join('C:/Users/weeze/Documents/neuralcrawling/neuralcrawling/spiders/', 'electronics.csv'), index=False)
