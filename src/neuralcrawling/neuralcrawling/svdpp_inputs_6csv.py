...
def start():
    try:
        # check whether there are 9 different arguments
        if len(sys.argv) != 10:
            print("Usage: python svdpp_inputs_5csv_code.py <src filepath1> <src filepath2> <src filepath3> <src filepath4> <src filepath5> <src filepath6> <userID> <prodID> <no of recommendation>")
            sys.exit(1)
        ...
        arg_filepath5 = sys.argv[5]
        arg_filepath6 = sys.argv[6]
        
        # specify userID, prodID, no_of_reco from arguments
        arg_userID = sys.argv[7]
        arg_prodID = sys.argv[8]
        arg_no_of_reco = sys.argv[9]
        ...
        csv_files = []
        for folder in [arg_filepath1, arg_filepath2, arg_filepath3, arg_filepath4, arg_filepath5, arg_filepath6]:
